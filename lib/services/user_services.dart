...
class UserService {
  ...
  /// Fetches similar tvShows for a given tvId
  Future<List<Map<String, dynamic>>> getSimilarTvShows(int tvId) async {
    try {
      final response = await _dio.get(
        '/tv/$tvId/similar',
        queryParameters: {
      ...
      print('Error fetching similar tv shows for tv $tvId: $e');
      return [];
    }
  }
