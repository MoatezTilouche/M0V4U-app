...
class HomeScreen extends StatelessWidget {
          ...
          child: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  _buildHeaderSection(home_provider),
                  ...
                  home_provider.popularMovies.isNotEmpty
                    ...
                    enabled: home_provider.isLoading,
                    child: MovieCarousel(
                        movies: home_provider.popularMovies.take(10).toList()),
                  )
                      : const Center(
                    child: Text(
  ...
  Widget _buildHeaderSection(HomeScreenProvider homeProvider) {
    return Container(
      width: double.infinity,
      height: 250,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text(
              'Millions of films, actors, and series...',
              style: TextStyle(
