...
class _TvShowsScreenState extends State<TvShowsScreen> with SingleTickerProviderStateMixin {
  ...
  void _onSearchChanged(String query) {
    ...
    _debounce = Timer(const Duration(milliseconds: 1000), (){
      ...
      if (query.isNotEmpty) {
        Provider.of<TvShowsProvider>(context, listen: false).searchTvShows(query);
      }
    });
  }
        ...
        children: [
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(
                    ...
                    onPressed: () {
                      ...
                      Provider.of<TvShowsProvider>(context, listen: false).searchTvShows('');
                    },
                  ),
                ),
          ...
          Expanded(
            child: Consumer<TvShowsProvider>(builder: (context, provider, _) {
              ...
              return Skeletonizer(
                enabled: provider.isLoading && tvShowsToDisplay.isEmpty,
                child: GridView.builder(
                  ...
                  itemCount: tvShowsToDisplay.length + (hasMorePages && provider.isLoading ? 2 : 0),
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          AnimatedNavigator.pushZoomIn(context, TvShowDetailScreen(tvShowId: tvshow.id!));
                              ...
                              child: Image.network(
                                ...
                                errorBuilder: (context, error, stackTrace) {
                                  return Container(
                                    ...
                                    child: Icon(Icons.tv_rounded, size: 50, color: Colors.grey[600]),
                                  );
                                },
                              ),
                            ),
